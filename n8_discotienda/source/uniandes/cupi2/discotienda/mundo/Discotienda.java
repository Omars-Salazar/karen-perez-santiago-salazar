...
public class Discotienda
{
    ...
    // -----------------------------------------------------------------
/**
* Generar un inoforme de discos en la discotienda
...
*/
    ...
    public void generarInformeDiscos() throws FileNotFoundException
    {
    	...
    	//recorrido sobre discos
    	for(int i=0;i<discos.size();i++)
    	{
    		//extraer la infrmacion de cada disco
     ...
     * @throws IOException
     */
    public void generarInformeDiscosEconomicos() throws IOException{
    	File archivoInforme = new File("./data/discosCostosos.txt");
    	PrintWriter escritor = new PrintWriter(archivoInforme);
    	
    	
    	escritor.println("Reporte de discos");
    	escritor.println("=================");
    	
    	for(int k=0;k<discos.size();k++) {
    		Disco miDisco = (Disco)discos.get(k);
    		if((miDisco.darGenero().equals("ROCK")|| miDisco.darGenero().equals("POP"))&& miDisco.darPrecioDisco()<=1000) {
    			
    			escritor.println(   "Nombre: "+miDisco.darNombreDisco()+
    								"Artista: " +miDisco.darArtista()+
    								"Genero: " +miDisco.darGenero()+
    ...
    public String metodo2( )
    {
    	try {
    		...
    		return "El informe se creó correctamente.";
    	}catch (Exception e) {
